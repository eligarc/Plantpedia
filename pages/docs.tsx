...
export default function Home() {
	// const fetchPlants = () => fetch(`https://graphql.contentful.com/content/v1/spaces/w34nyj5hhyfo`, {
	// 	method: 'POST',
	// 	headers: {
	// 		'content-type': 'application/json',
	// 		Authorization: 'Bearer zOcObY8PwomOsPwUk8kpgFs63I6htT-px8BMfkb1dos',
	// 	},
	// 	body: JSON.stringify({
	// 		query: `{
	...
	// })
	useEffect(() => {
		// fetchPlants().then(res => res.json()).then(console.log)
